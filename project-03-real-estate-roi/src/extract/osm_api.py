...
מודול לשליפת נתוני מיקום מ-OpenStreetMap
...
class OpenStreetMapClient:
    ...
    def get_train_stations(
        ...
        """
        Get train/metro stations in area.

        Args:
            bbox: Bounding box dict with south, west, north, east
            city: City name to search in (Hebrew)

        Returns:
            List of train station amenities
        """
    ...
    def get_schools(
        ...
        Args:
            bbox: Bounding box
            school_type: Filter by type (primary, secondary, etc.)

        Returns:
            List of school amenities
        """
        bbox = bbox or ISRAEL_BBOX
    ...
    def get_all_amenities_for_city(self, city_bbox: Dict) -> Dict[str, List[Amenity]]:
        ...
        Args:
            city_bbox: City bounding box

        Returns:
            Dictionary with amenity type as key and list of amenities as value
        """
        return {
...
def find_nearest_amenity(
    ...
    Args:
        ...
        amenities: List of amenities to search

    Returns:
        Tuple of (nearest amenity, distance in km) or (None, None)
    """
...
def calculate_distances_for_property(
    lat: float,
    lon: float,
    amenities: Dict[str, List[Amenity]]
) -> Dict[str, float]:
    """
    ...
    Args:
        ...
        amenities: Dictionary of amenity lists by type

    Returns:
        Dictionary with distance to nearest of each type
    """
    distances = {}
